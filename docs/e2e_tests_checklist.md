...
### [x] 1.2 Transbordo de Projeção na Virada de Ano e Meses Bissextos
...
### [x] 1.3 Coexistência de Múltiplas Simulações Ativas de Naturezas Distintas
...
### [x] 2.2 Reatividade de Limite de Crédito sob Pagamento Parcial/Antecipado
...
### [x] 2.3 Estorno de Transação e Recálculo Automático da Projeção de Fatura
...
### [x] 3.2 Teto Emergencial sob Despesas Inesperadas
...
### [x] 3.3 Priorização Inteligente de Suspensão de Metas
- **Objetivo:** Testar se o sistema consegue manter ativos os aportes de metas de alta prioridade (Priority #1) enquanto suspende apenas as metas menos prioritárias (Priority #2 e #3) in cenários de aperto de caixa parcial (onde a liquidez não está totalmente no vermelho, mas há déficit parcial).
...
### [x] 4.1 Resiliência com Serviço de IA Indisponível (API Offline)
...
### [x] 4.2 Injeção Reativa de Fatos da Memória Jarvis no Dashboard
...
### [x] 4.3 Agendamento Automatizado de Parcelamento a partir do Chat do Copiloto
...
### [x] 5.1 Sincronização offline-first via Dexie e Supabase
...
### [x] 5.2 Validação de Inputs Extremos e Sanitização de Formulários
